...
INTENT_SPECS: tuple[IntentSpec, ...] = (
    ...
    IntentSpec(
        ...
        _any_pat(
            r"introducing",
            r"discover",
            r"new (?:product|arrival|collection|range|" r"model|launch)",
            r"exclusive",
            r"launch(?:ed|ing)?",
            r"unveil\w*",
            r"check out (?:our|the)",
            r"visit our (?:website|store|showroom)",
            r"our brand",
            r"limited edition",
        ),
    ...
    IntentSpec(
        ...
        _any_pat(
            ...
            r"pre-?order",
            r"add to cart",
            r"book (?:your )?(?:slot|seat|ticket|" r"now)",
            r"checkout",
            r"on sale",
            r"get yours",
            r"for sale",
    ...
    IntentSpec(
        ...
        _any_pat(
            ...
            r"bank transfer",
            r"settle (?:the )?(?:amount|" r"dues|bill)",
            r"outstanding",
            r"due amount",
            r"payable",
            r"recharge",
    ...
    IntentSpec(
        "Request OTP",
        _any_pat(
            r"share (?:the|your|this)? ?(?:otp|code)",
            r"send (?:me|us|the|your)? ?" r"(?:otp|code)",
            r"enter (?:the )?(?:otp|code)",
            r"provide (?:the|your) " r"(?:otp|code)",
            r"what is your (?:otp|code)",
            r"forward (?:the|your) " r"(?:otp|code)",
            r"give (?:me|us) (?:the|your)? ?(?:otp|code)",
            r"tell (?:me|us) the (?:otp|code)",
            r"confirm (?:the )?(?:otp|code)",
    ...
    IntentSpec(
        ...
        _any_pat(
            ...
            r"personal details",
            r"bank statement",
            r"upload (?:your )?(?:photo|selfie|id|documents)",
            r"voter id",
            r"passport",
            r"gstin",
            r"contact details",
    ...
    IntentSpec(
        ...
        _any_pat(
            r"verify\w*",
            r"verification",
            r"confirm (?:your|the) (?:account|" r"identity|details)",
            r"validate",
            r"authenticate",
            r"complete (?:your )?" r"kyc",
    ...
    IntentSpec(
        "Request Contact",
        _any_pat(
            r"call (?:us|now|me|this number)",
            r"contact (?:us|me|our)",
            r"contact number",
            r"reach (?:us|out)",
            r"whatsapp",
            r"text (?:us|me)",
            r"reply (?:yes|stop|1|2|\bno\b)",
            r"toll-?free",
            r"helpline",
            r"support (?:line|desk)",
            r"send (?:us )?(?:an? )?(?:email|" r"message)",
            r"inbox us",
            r"dm us",
            r"\bcall\b",
        ),
    ...
    IntentSpec(
        ...
        _any_pat(
            ...
            r"congratulations?",
            r"prize",
            r"gift (?:card|" r"voucher)",
            r"cashback",
            r"reward\w*",
            r"bonus",
            r"lucky (?:winner|" r"draw)",
            r"raffle",
            r"jackpot",
            r"free (?:gift|trip|iphone|laptop|" r"prize|voucher)",
            r"win\w* (?:a|an|the) (?:prize|reward|gift)",
        ),
    ...
    IntentSpec(
        ...
        _any_pat(
            ...
            r"arrest",
            r"prosecut\w*",
            r"police (?:case|complaint)",
            r"recovery (?:agent|team)",
            r"blacklist",
    ...
    IntentSpec(
        ...
        _any_pat(
            ...
            r"caution",
            r"alert",
            r"security (?:risk|threat|warning|" r"breach|alert)",
            r"fraud (?:alert|warning)",
            r"be careful",
            r"beware",
            r"do not share",
            r"unauthorized",
            ...
            r"compromised",
            r"phishing",
            r"do not (?:click|respond|share|reveal)",
            r"scam\w*",
        ),
    ),
    IntentSpec(
        ...
        _any_pat(
            ...
            r"surprise",
            r"find out",
            r"click (?:here )?to (?:find out|see|know)",
            r"don't miss",
            r"curious\b",
            r"what's inside",
            r"open (?:this|the|me)",
    ...
    IntentSpec(
        ...
        _any_pat(
            ...
            r"expiring",
            r"last chance",
            r"final (?:call|warning|reminder)",
            r"limited (?:time|period|offer)",
            r"act now",
            r"hurry",
            r"do not delay",
            r"before (?:midnight|tomorrow|end of day)",
            r"within 24 (?:hours|hrs)",
            r"expire\w*",
            r"ending (?:soon|today|tonight)",
        ),
        boost=_urgency_boost,
    ),
    IntentSpec(
        ...
        _any_pat(
            ...
            r"family",
            r"weekend plans",
            r"how is (?:your|the) (?:day|week|family)",
    ...
    IntentSpec(
        ...
        _any_pat(
            ...
            r"can you help",
            r"assist me",
            r"technical (?:support|assistance)",
...
class IntentService:
    ...
    def detect(
        ...
        *,
        ...
        results.sort(
            key=lambda item: (-item.confidence, _INTENT_ORDER.get(item.name, 99))
        )
